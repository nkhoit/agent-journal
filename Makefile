...
.PHONY: all build fmt fmt-check test migration-test contract-test bootstrap-test foreign-uid-test clippy openapi-check redocly-check markdown-check hygiene-check check
...
check: fmt-check test clippy build migration-test contract-test bootstrap-test openapi-check redocly-check markdown-check hygiene-check

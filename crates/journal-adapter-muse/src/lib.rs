...
impl Config {
    ...
    pub fn usage() -> &'static str {
        "Usage: journal-adapter-muse --central-endpoint URL --delivery-credential-file PATH --spool-db PATH --instance-id ID --routes-file PATH --muse-drop-dir DIR [--once] [--poll-seconds N]"
    }
}
